...
======
- Add one test user for each role so that i can test the login system. Use the same password(password123). keep these test users consistent throught the system development and all migrations in the following stages. 
