...
const emit = defineEmits(["close", "vendor-updated"]);
...
const handleSubmit = async () => {
    ...
    try {
        await purchaseOrderStore.updateVendor(props.vendor.id, form.value);

        Swal.fire({
            icon: "success",
            title: "Vendor Updated",
            text: "The vendor information has been successfully updated.",
            timer: 2000,
