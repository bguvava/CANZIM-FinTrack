        ...
        <div class="space-y-6">
            ...
            <div v-if="activeTab === 'generate'" class="space-y-6">
                ...
                <div class="grid grid-cols-6 gap-3">
                    ...
                    >
                        <i
                            class="fas fa-sliders-h mb-2 text-3xl"
                            :class="
                                selectedReportType === 'custom'
                                    ? 'text-gray-700'
                                    : 'text-gray-600'
                            ...
                            >
                                ...
                                <td class="whitespace-nowrap px-6 py-4">
                                    <span
                                        ...
                                        :class="getReportTypeBadge(report.type)"
                                    >
...
const generateReport = async () => {
    ...
    try {
        ...
        const response = await api.post(endpoint, reportForm.value);
